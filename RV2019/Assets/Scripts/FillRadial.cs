...
namespace VRStandardAssets.Utils
{
    ...
    public class FillRadial : MonoBehaviour
    {
        ...
        [SerializeField] private float m_SelectionDuration = 0.5f;                                // How long it takes for the bar to fill.
        ...
        private void Awake()
        {
            m_Selection = GameObject.Find("UISelectionBar").GetComponent<Image>();
        }
