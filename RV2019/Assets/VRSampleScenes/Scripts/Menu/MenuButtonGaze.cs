...
namespace VRStandardAssets.Menu
{
    ...
    [RequireComponent(typeof(SelectionRadial))]
    public class MenuButtonGaze : MonoBehaviour
    {
        public event Action<MenuButtonGaze> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        ...
        //QUNADO O BOTAO É ATIVADO, ESSA FUNCAO EH CHAMADA. AQUI VOCE DEVE PROGRAMAR O SEU CODIGO PARA O SEU BOTAO...
